  ...
  return (
    <div name='contact' className='w-full h-screen  bg-blue-950  text-blue-50 flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/c197eecd-324d-4e73-ba26-c04ec2c00415" className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className='bg-blue-100 p-2 border-2 border-[#ffcc00]' type="text" placeholder='Name' name='name'/>
            <input className='bg-blue-100 my-4 p-2 border-2 border-[#ffcc00]' type="email" placeholder='E-mail' name='email' />
            <textarea className='bg-blue-100 p-2 border-2 border-[#ffcc00]' name="message" rows="10" placeholder='Message'></textarea>
